...
const photoFiles = [
  'queens-park-savannah (1).jpg',
  'queens-park-savannah (2).jpg',
  'queens-park-savannah (3).jpg',
  'queens-park-savannah (4).jpg',
  'queens-park-savannah (5).jpg',
  'queens-park-savannah (6).jpg',
  'queens-park-savannah (7).jpg',
  'queens-park-savannah (8).jpg',
  'queens-park-savannah (9).jpg',
  'queens-park-savannah (10).jpg',
  'queens-park-savannah (11).jpg',
  'queens-park-savannah (12).jpg',
  'queens-park-savannah (13).jpg',
  'queens-park-savannah (14).jpg',
  'queens-park-savannah (15).jpg',
  'queens-park-savannah (16).jpg',
  'queens-park-savannah (17).jpg',
  'queens-park-savannah (18).jpg',
  'queens-park-savannah (19).jpg',
];
...
export default function Gallery() {
  ...
  const photos = photoFiles.map((file, i) => ({
    src: `/gallery/${file}`,
    alt: captions?.[i] || `Queen's Park Savannah ${i + 1}`,
  }));
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-8">
              <a
                href="https://maps.app.goo.gl/YuLjuPMHowrSose38"
                target="_blank"
